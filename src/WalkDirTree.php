...
class WalkDirTree {
     ...
     * Значения
     *  - всегда массив, в котором есть ключ [''], в котором содержится идентификатор базового пути $basePathId
     *  - если используется кэш, то добавляются ключи, равные маске выборки файлов (она не может быть пустой),
     *     тогда значением будет массив, содержащий короткие имена файлов, найденных по этой маске в этой папке.
     * 
     * @var array<string,array<string,int|array<string>>>
     */
